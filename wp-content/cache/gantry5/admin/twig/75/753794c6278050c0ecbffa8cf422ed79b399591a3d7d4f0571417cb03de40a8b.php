...
class __TwigTemplate_eda6fcd46e98bf2e10feeffc9ea910a73c6ba9a2793759d5b07d32a471b3dda5 extends \Twig\Template
{
...
($context["gantry"] ?? null), "outlines", []), "title", [0 => $this->getAttribute($this->getAttribute($context["atom"], "inherit", []), "outline", [])], "method")) . "</strong>"))) . "<br />ID: ") . $this->getAttribute($this->getAttribute($context["atom"], "inherit", []), "atom", [])) . "<br />Replace: ") . twig_join_filter($this->getAttribute($this->getAttribute($context["atom"], "inherit", []), "include", []), ", ")) . "\"")) : (""));
    ...
    {
        return new Source("", "@gantry-admin/pages/configurations/page/atoms.html.twig", "E:\\xampp\\htdocs\\portfolio\\wp-content\\plugins\\gantry5\\admin\\templates\\pages\\configurations\\page\\atoms.html.twig");
    }
}
